...
This project challenges your team to collaboratively develop an **interactive full-stack application** using **React** (frontend) and **NodeJS/Sequelize** (backend). It is the culmination of your learning in the bootcamp, showcasing your technical skills and teamwork.
...
- Define individual roles and responsibilities:
  ...
  - **Backend Developer(s)**: Create and maintain the NodeJs/Sequelize API and database.
